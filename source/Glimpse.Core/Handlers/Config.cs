...
namespace Glimpse.Core.Handlers
{
    ...
    public class Config : IGlimpseHandler
    {
        ...
        public void ProcessRequest(HttpContextBase context)
        {
            ...
            response.Write("<div class=\"content\"><div class=\"logo\"><blockquote>What Firebug is for the client, Glimpse does for the server... in other words, a client side Glimpse into what's going on in your server.</blockquote><h1>Glimpse</h1><div>A client side Glimpse to your server</div></div>");
